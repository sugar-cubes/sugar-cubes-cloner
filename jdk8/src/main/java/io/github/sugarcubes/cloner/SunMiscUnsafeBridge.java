 ...
 * @author Maxim Butov
 */
class SunMiscUnsafeBridge implements UnsafeBridge {

    /**
     * The {@link sun.misc.Unsafe} instance.
     */
    private final sun.misc.Unsafe unsafe = ClonerExceptionUtils.replaceException(() -> {
        Field theUnsafe = ReflectionUtils.getField(sun.misc.Unsafe.class, "theUnsafe");
