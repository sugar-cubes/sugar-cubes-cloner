 ...
 *
 * {@link ReflectionCopier} is not suitable for {@link IdentityHashMap} because the result {@link IdentityHashMap#table} has its
...
public class IdentityHashMapCopier extends TwoPhaseObjectCopier<IdentityHashMap<Object, Object>> {
    ...
    @Override
    public void deepCopy(IdentityHashMap<Object, Object> original, IdentityHashMap<Object, Object> clone, CopyContext context) throws Exception {
